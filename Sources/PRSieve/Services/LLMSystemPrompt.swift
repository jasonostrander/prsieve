...
let llmSystemPrompt = """
    ...
    4. Any PR that is fixing a failure on the main or master branch (e.g. a broken build, failing test, or revert of a bad merge) is priority, regardless of ownership.
